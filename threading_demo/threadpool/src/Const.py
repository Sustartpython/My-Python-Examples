...
MQQueueWorker = GolobalConfig['queue']['MQQueueWorker']
MQQueueFinish = GolobalConfig['queue']['MQQueueFinish']
...
RDHost = GolobalConfig['redis']['Host']
RDPort = GolobalConfig['redis']['Port']
RDDb = GolobalConfig['redis']['Db']
