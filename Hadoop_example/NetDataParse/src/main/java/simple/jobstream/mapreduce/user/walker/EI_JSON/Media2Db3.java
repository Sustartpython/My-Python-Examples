...
//
public class Media2Db3 extends InHdfsOutHdfsJobInfo {
	private static Logger logger = Logger
			.getLogger(Media2Db3.class);
	
	private static String postfixDb3 = "ei_media_e";
	private static String tempFileDb3 = "/RawData/EI_JSON/rel_file/ei_template_media_e.db3";
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable value, Context context)
			...
			String sql = "INSERT INTO modify_title_info([lngid], [media_e]) ";
			sql += " VALUES ('%s', '%s');";
			sql = String.format(sql, lngid, media_e);								
