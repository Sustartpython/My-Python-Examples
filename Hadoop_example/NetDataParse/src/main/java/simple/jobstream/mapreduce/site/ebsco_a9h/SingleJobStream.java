package simple.jobstream.mapreduce.site.ebsco_a9h;
...
public class SingleJobStream {
	public static LinkedHashSet<JobNode> getJobStream() {
		...
		String rawHtmlDir = "/RawData/ebsco/a9h_ASC/big_html/20190704";
		String rawXXXXObjectDir = "/RawData/ebsco/a9h_ASC/XXXXObject";
		String latest_tempDir = "/RawData/ebsco/a9h_ASC/latest_temp"; // 临时成品目录
		String latestDir = "/RawData/ebsco/a9h_ASC/latest"; // 成品目录
		String newXXXXObjectDir = "/RawData/ebsco/a9h_ASC/new_data/XXXXObject"; // 本次新增的数据（XXXXObject）
		String std_Dir_zt = "/RawData/ebsco/a9h_ASC/new_data/zt/StdEBSCO";
		String std_Dir_a = "/RawData/ebsco/a9h_ASC/new_data/a/StdEBSCO";
		String std="/RawData/ebsco/a9h_ASC/latest_XXXXObject";
		
		JobNode Html2XXXXObject = new JobNode("ebsco_a9h_Parse", rootDir, 0,
				"simple.jobstream.mapreduce.site.ebsco_a9h.Html2XXXXObject");
		Html2XXXXObject.setConfig("inputHdfsPath", rawHtmlDir);
		Html2XXXXObject.setConfig("outputHdfsPath", rawXXXXObjectDir);

		// 将历史累积数据和新数据合并去重
//
		JobNode MergeXXXXObject2Temp = JobNodeModel.getJonNode4MergeXXXXObject("ebsco_a9h_MergeXXXXObject2Temp",
				rawXXXXObjectDir, latestDir, latest_tempDir, 200);

//		// 生成新数据。不能是“总数据-老数据”，新数据要全刷一遍。
		JobNode GenNewData = JobNodeModel.getJonNode4ExtractXXXXObject("ebsco_a9h_GenNewData", 
				rawXXXXObjectDir, latest_tempDir,newXXXXObjectDir, 200);	
			

		 //导出数据到 db3
		JobNode StdNew = JobNodeModel.getJobNode4Std2Db3("ebsco_a9h_zt","simple.jobstream.mapreduce.site.ebsco_a9h.StdXXXXobject_zt", 
				newXXXXObjectDir, std_Dir_zt, "zt_ebscoa9hjournal","/RawData/_rel_file/zt_template.db3",1);

//		// 备份累积数据
		JobNode Temp2Latest = JobNodeModel.getJobNode4CopyXXXXObject("ebsco_a9h_Temp2Latest", latest_tempDir, latestDir);
		
		//导出数据到a层
		JobNode Std2Db3A = JobNodeModel.getJobNode4Std2Db3("ebsco_a9h_a", "simple.jobstream.mapreduce.site.ebsco_a9h.StdXXXXobject_a", newXXXXObjectDir, 
				std_Dir_a, 
		             "a_ebscoa9hjournal", 
