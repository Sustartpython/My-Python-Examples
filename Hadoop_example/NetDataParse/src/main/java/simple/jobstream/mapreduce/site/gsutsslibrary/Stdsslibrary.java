...
public class Stdsslibrary extends InHdfsOutHdfsJobInfo {
    ...
    private static String postfixDb3 = "gsutsslibrarybook";
    ...
    public void pre(Job job) {
    	String jobName = "gsutsslibrary." + this.getClass().getSimpleName();
        if (testRun) {
    ...
    public void SetMRInfo(Job job) {
        ...
        job.setMapperClass(Stdsslibrary.ProcessMapper.class);
        job.setReducerClass(Stdsslibrary.ProcessReducer.class);
    ...
    public static class ProcessMapper extends Mapper<Text, BytesWritable, Text, NullWritable> {
        ...
        public void map(Text key, BytesWritable value, Context context) throws IOException, InterruptedException {
            ...
            String lngID = "";
            String batch="";
            String provider="gsutsslibrarybook";
            String provider_url="";
            String provider_id="";
            String country="CN";
            ...
            lngID = "GSUT_SSLIBRARY_TS_" + rawid;
