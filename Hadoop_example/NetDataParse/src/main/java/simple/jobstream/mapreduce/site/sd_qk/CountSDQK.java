...
public class CountSDQK extends InHdfsOutHdfsJobInfo {
	...
	public static final String inputHdfsPath = "/RawData/CQU/elsevier/sd_qk/latest";
	//public static final String inputHdfsPath = "/user/ganruoxun/CNKIBasicInfo/TitleInfo/TitleInfo";
	public static final String outputHdfsPath = "/vipuser/walker/output/sd_qk/CountSDQK";
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable value, Context context)
			...
			String outKey = identifier_pissn + "\t" + source;
