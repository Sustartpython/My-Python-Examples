...
//输入应该为去重后的html
public class StdXXXXObjectForZLF_old extends InHdfsOutHdfsJobInfo {
	...
	public static String ref_file_path = "/RawData/cnki/hy/ref_file/lngid_20190711.txt";
...
//				}
			...
			NetFullTextAddr = "http://kns.cnki.net/kcms/detail/detail.aspx?dbcode=CIPD&filename=" + rawid;
			...
			String sql = "INSERT INTO modify_title_info([classtypes],"
					+ "[showclasstypes],[srcID],[titletype],[type],[language],"
					+ "[NetFullTextAddr_all_std],[NetFullTextAddr_all],[NetFullTextAddr],"
					+ "[lngID],[rawid], [title_c], [years],  [hymeetingrecordname], [Showwriter], "
					+ "[Showorgan], [media_c], [hymeetingplace], [keyword_c], [remark_c], "
					+ "[hyhostorganization],[hymeetingdate],[class]) ";
