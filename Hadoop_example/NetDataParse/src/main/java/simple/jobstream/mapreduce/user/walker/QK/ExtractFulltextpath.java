...
//
public class ExtractFulltextpath extends InHdfsOutHdfsJobInfo {
	private static Logger logger = Logger
			.getLogger(ExtractFulltextpath.class);
	...
	public static final String outputHdfsPath = "/user/tanl/TL/zlfstat/ExtractFulltextpath/zlf_qk_fulltextpath";
	
	private static String postfixDb3 = "zlf_qk_fulltextpath";
	private static String tempFileDb3 = "/user/tanl/TL/zlfstat/ExtractFulltextpath/template/zlf_qk_fulltextpath_template.db3";
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable value, Context context)
			...
			*/
			...
			if (pageInt < 1) {
				context.getCounter("map", "pageInt < 1").increment(1);
				return;
			}
