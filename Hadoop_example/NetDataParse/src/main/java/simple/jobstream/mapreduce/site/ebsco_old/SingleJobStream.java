...
//		String latest_tempDir = "/RawData/ebsco/Ebsco_new/latest_temp"; // 临时成品目录
		String latestDir = "/RawData/ebsco/ebsco_old/latest"; // 成品目录
...
//		String std_Dir_a = "/RawData/ebsco/Ebsco_new/new_data/a/StdEBSCO";
		String std_Dir_latest_a9h="/RawData/ebsco/ebsco_old/new_data/StdEBSCO";
		String std_Dir_latest_bth="/RawData/ebsco/ebsco_old/new_data/bth/StdEBSCO";
...
//		JobNode Temp2Latest = JobNodeModel.getJobNode4CopyXXXXObject("ebsco.Temp2Latest", latest_tempDir, latestDir);
		...
		//导出数据到a层(a9h)
//		JobNode Std2Db3A_a9h = JobNodeModel.getJobNode4Std2Db3("ebsco_old.Std2Db3A", "simple.jobstream.mapreduce.site.ebsco_old.StdXXXXobject_a_a9h", latestDir, 
//				std_Dir_latest_a9h, 
//		             "ebscoa9hjournal_a", 
//		             "/RawData/_rel_file/base_obj_meta_a_template_qkwx.db3", 
//		              300);
//		导出数据到a层(bth)
//		JobNode Std2Db3A_bth = JobNodeModel.getJobNode4Std2Db3("ebsco_old.Std2Db3A", "simple.jobstream.mapreduce.site.ebsco_old.StdXXXXobject_a_bth", latestDir, 
//				std_Dir_latest_bth, 
//		             "ebscobthjournal_a", 
//		             "/RawData/_rel_file/base_obj_meta_a_template_qkwx.db3", 
//		              1);
...
//		 提出lastest中数据
//		result.add(Std2Db3A_a9h);
//		Std2Db3A_a9h.addChildJob(Std2Db3A_bth);
		
		//分开latest
		JobNode split_latest= new JobNode("ebsco_latest_ID",rootDir, 0, "simple.jobstream.mapreduce.site.ebsco_old.split_latest");
		result.add(split_latest);
