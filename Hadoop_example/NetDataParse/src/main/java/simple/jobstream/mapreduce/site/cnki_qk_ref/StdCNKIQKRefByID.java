...
//输入应该为去重后的html
public class StdCNKIQKRefByID extends InHdfsOutHdfsJobInfo {
	private static Logger logger = Logger
			.getLogger(StdCNKIQKRefByID.class);
	
	private static boolean testRun = false ;
	private static int testReduceNum = 1;
	private static int reduceNum = 1;
	
	public static String inputHdfsPath = "/RawData/cnki/qk/ref/latest";
	public static String outputHdfsPath = "/vipuser/walker/output/StdCNKIQKRefByID";
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable value, Context context)
			...
			if (!lngid.equalsIgnoreCase("KJJB201512007")) {
				return;
			}
			...
			String sql = "INSERT INTO ref_zk([id], [rawsourceid], [lngsourceid], [refertext], [strtitle], [strtype], [strname], [strwriter1], [stryearvolnum], [strpubwriter]) ";
			sql += " VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');";
			sql = String.format(sql, lngid, rawsourceid, lngsourceid, refertext, strtitle, strtype, strname, strwriter1, stryearvolnum, strpubwriter);								
