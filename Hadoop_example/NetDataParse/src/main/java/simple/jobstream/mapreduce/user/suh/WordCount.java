package simple.jobstream.mapreduce.user.suh;
...
public class WordCount extends InHdfsOutHdfsJobInfo {
	...
	public static final String inputHdfsPath = "/user/suh/input";
	public static final String outputHdfsPath = "/user/suh/output";
