...
//
public class StdEI extends InHdfsOutHdfsJobInfo {
	private static Logger logger = Logger
			.getLogger(StdEI.class);
	
	private static String postfixDb3 = "ei";
	private static String tempFileDb3 = "/vipuser/walker/input/template/ei_template.db3";
