...
//输入应该为去重后的html
public class Std2DbZTCniprCover extends InHdfsOutHdfsJobInfo {
	private static Logger logger = Logger.getLogger(Std2DbZTCniprCover.class);
...
//					pct_pub_data, priority, cover_path);
			...
			String sql = "INSERT INTO modify_title_info_zt([lngid],[identifier_pissn],[identifier_standard],[cover])";
			sql += " VALUES ('%s','%s','%s','%s');";
			sql = String.format(sql, lngid,app_no,pub_no,coverurl); 
