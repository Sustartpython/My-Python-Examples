...
public class XObj2Db3 extends InHdfsOutHdfsJobInfo {
	...
	private static String postfixDb3 = "cnki_keyword_a";
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable value, Context context)
			...
			if ((alt_word.length() < 1) && (summary.length() < 1)) {
				context.getCounter("map", "alt_word && summary null").increment(1);
				return;
			}
			...
			String sql = "INSERT INTO keyword([id], [keyword], [alt_word], [summary]) ";
			sql += " VALUES ('%s', '%s', '%s', '%s');";
			sql = String.format(sql, id, keyword, alt_word, summary);								
	...
	public static class ProcessReducer extends
				...
				throws IOException, InterruptedException
		{
			try {
				...
				String tempPathFile = "/RawData/cnki/keyword_a/template/cnki_keyword_a_template.db3";
