...
//
public class Filter_99_98_fz extends InHdfsOutHdfsJobInfo {
	private static int reduceNum = 0;

	// 源数据最新目录: /user/tanl/TL/zlfMergeCrontab/BasicInfo/TitleInfo/TitleInfo
	// 反证之后最新目录:   /user/tanl/TL/zlfFzCrontab/BasicInfo/TitleInfo/TitleInfo
	public static String inputHdfsPath = "/user/tanl/TL/zlfFzCrontab/BasicInfo/TitleInfo/TitleInfo";
	public static String outputHdfsPath = "/RawData/BasicInfo_Filter_99_98_fz";
