...
//输入应该为去重后的html
public class StdZT extends InHdfsOutHdfsJobInfo {
	private static Logger logger = Logger
			.getLogger(StdZT.class);
...
//			netfulltextaddr_all = createnetfulltextaddr_all(rawid).toString();
			...
			type = "3";
			String medium = "2";
			String provider = "rucjournal";
			provider_url = provider+"@"+"http://ipub.exuezhe.com/paper.html?id="+rawid;
			...
			sql = String.format(sql, lngid, rawid , source , years , num ,
					...
					type , medium , provider , provider_url , 
					provider_id , batch ,begin_page,end_page,
					jump_page,description_fund,date_created);
