...
//	private static String tempFileDb3 = "/RawData/_rel_file/zt_template.db3";
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable value, Context context)
			...
			//智图对应表
			String sql = "INSERT INTO modify_title_info_zt([lngid],[rawid],[provider],[batch],[identifier_doi],[type],[provider_url],[title],[description],[page],[beginpage],[endpage],[date_created],[subject],[pagecount],[title_series],[creator],[gch],[source],[date],[volume],[issue],[identifier_pissn],[identifier_eissn],[publisher],[country],[language],[cited_cnt],[medium],[provider_id])";
			sql += " VALUES ('%s', '%s','%s','%s', '%s','%s','%s', '%s','%s','%s', '%s','%s', '%s','%s','%s', '%s','%s','%s', '%s','%s','%s', '%s','%s', '%s','%s','%s', '%s','%s','%s', '%s')";
			sql = String.format(sql,lngid,rawid,provider,batch,doi,source_type,provider_url,title,abstracts,begin_page_sort,begin_page,end_page,pub_date,keyword,page_cnt,column_info,author,gch,journal_name,pub_year,vol,issue,issn,eissn,publisher,country,language,cited_cnt,medium,provider_id);
