...
public class XObj2Db3 extends InHdfsOutHdfsJobInfo {
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable value, Context context)
			...
			if ((related_word.length() < 1) && (similar_word.length() < 1)) {
				context.getCounter("map", "related_similar null").increment(1);
				return;
			}
			
			if ((related_word.length() > 0) && (similar_word.length() > 0)) {
				context.getCounter("map", "related_similar").increment(1);
			}
			...
			String sql = "INSERT INTO keyword([id], [keyword], [related_word], [similar_word]) ";
			sql += " VALUES ('%s', '%s', '%s', '%s');";
			sql = String.format(sql, id, keyword, related_word, similar_word);								
