...
public class MergeXXXXObject2Temp extends InHdfsOutHdfsJobInfo {
	...
	{
		String jobName = "cnkithesis.MergeXXXXObject2Temp";
	...
	public static class ProcessMapper extends 
	    ...
	    public void map(Text key, BytesWritable value, Context context
	    	...
	    	if (inputPath.equals("/bs/latest")) {		
	    		context.getCounter("map", "旧数据").increment(1); //统计旧数据
			}
	    	else {		
	    		context.getCounter("map", "新增数据").increment(1); //统计新数据
			}
