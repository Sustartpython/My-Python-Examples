...
public class StdSslibrary extends InHdfsOutHdfsJobInfo {
	...
	private static String postfixDb3 = "snnusslibrarybook";
	...
	public void pre(Job job) {
		String jobName = "snnusslibrarybook." + this.getClass().getSimpleName();
		if (testRun) {
	...
	public static class ProcessMapper extends Mapper<Text, BytesWritable, Text, NullWritable> {
		...
		public void map(Text key, BytesWritable value, Context context) throws IOException, InterruptedException {
		    ...
		    String lngID = "";
		    String batch="";
		    String provider="snnusslibrarybook";
		    String provider_url="";
		    String provider_id="";
		    String country="CN";
			...
			subject_clc =StringHelper.cleanSemicolon(subject_clc.replaceAll(" ", ";"));
			rawid = key.toString();
			dxid = rawid;
			Date dt = new Date();
			...
			batch = nowDate+"00";
			String sub_db_id = "00078";
			if (rawid.length() > 0) {
				lngID = VipIdEncode.getLngid(sub_db_id, rawid, false);
			}
			provider_url = provider + "@http://www.sslibrary.com/book/card?cnFenlei="+cnFenlei+"&ssid="+ssid+"&d="+bookCardD+"&dxid="+dxid;
			provider_id = provider + "@" + rawid;

//			lngID = "SSLIBRARY_TS_" + rawid;
			...
			subject_clc = StringEscapeUtils.escapeSql(subject_clc);
