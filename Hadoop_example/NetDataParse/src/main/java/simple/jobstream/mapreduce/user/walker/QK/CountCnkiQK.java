...
public class CountCnkiQK extends InHdfsOutHdfsJobInfo {
	...
	public static final String inputHdfsPath = "/RawData/cnki/qk/detail/latest,/RawData/cnki/qk/ref/latest";
	//public static final String inputHdfsPath = "/user/ganruoxun/CNKIBasicInfo/TitleInfo/TitleInfo";
	public static final String outputHdfsPath = "/vipuser/walker/output/QK/CountCnkiQK";
	...
	public static class ProcessMapper extends
		...
		public void map(Text key, BytesWritable values, Context context)
			...
			if (inputPath.endsWith("detail/latest")) {
				context.getCounter("map", "detail").increment(1);
			}
			else if (inputPath.endsWith("ref/latest")) {
			...
			String outKey = lngid.substring(0, 4) + "\t" + years;
